...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QLabel, 
                             QSlider, QGroupBox, QHBoxLayout, QCheckBox)
...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("Blinn-Phong Shading Demo")
        ...
        self.blinn_phong_check = QCheckBox("Use Blinn-Phong Model")
        self.blinn_phong_check.setChecked(True)
        self.blinn_phong_check.stateChanged.connect(self.toggle_blinn_phong)
        ...
        group_layout.addWidget(self.blinn_phong_check)
    ...
    def toggle_blinn_phong(self, state):
        use_blinn_phong[None] = 1 if state == Qt.Checked else 0
