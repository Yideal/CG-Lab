...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("Phong Shading with Hard Shadows")
        ...
        self.shadow_check = QCheckBox("Enable Hard Shadows")
        ...
        group_layout.addWidget(self.shadow_check)
    ...
    def toggle_shadow(self, state):
        enable_shadow[None] = 1 if state == Qt.Checked else 0
